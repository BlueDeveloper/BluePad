      ...
      <div className="dialog-box dialog-box-sm" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="dialog-body">
          ...
          <div className="pro-gate-actions">
            <button className="license-activate-btn" onClick={() => { import("@tauri-apps/plugin-shell").then(m => m.open(import.meta.env.DEV ? "https://bluepad.work/sandbox/buy" : "https://bluepad.work/buy")).catch(() => window.open(import.meta.env.DEV ? "https://bluepad.work/sandbox/buy" : "https://bluepad.work/buy", "_blank")); }}>
              {t("trial.buyNow")}
            </button>
